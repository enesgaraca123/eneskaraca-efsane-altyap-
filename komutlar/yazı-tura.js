...
var AstralCode2 = cevaplar[Math.floor(Math.random() * cevaplar.length)];

if (AstralCode2 === "YAZI-TURA: __YAZI__**") {

const EmbedAstralCode = new Discord.MessageEmbed()

      .setColor(0xf4b942)
      .setDescription(AstralCode2)
      .setThumbnail(
...
return message.channel.send(EmbedAstralCode);
  ...
  } else if (AstralCode2 === "**YAZI-TURA: __TURA__**") {
